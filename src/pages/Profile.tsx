            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-8">
                ...
                <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 col-span-2 md:col-span-1">
                  ...
                  <p className="text-sm font-bold text-primary">Miami, USA</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/20">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-primary pb-2 border-b border-gray-100">+1 555 123 4567</p>
                  </div>
                  <div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/20">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm font-medium text-primary pb-2 border-b border-gray-100">Miami Beach, FL, USA</p>
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Nationality</label>
                    <p className="text-sm font-medium text-primary pb-2 border-b border-gray-100">United States</p>
                  </div>
                </div>
              </div>
            </motion.div>
