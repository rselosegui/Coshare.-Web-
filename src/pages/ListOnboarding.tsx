...
export const ListOnboarding = () => {
  ...
  const subcategories: Record<string, string[]> = {
    ...
    Others: ['High-Value Items', 'Collectibles']
  };
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] py-16 md:py-24 px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
      <SEO 
        ...
        description="List your asset for cosharing on Coshare. Invite friends, split expenses, and manage your asset with AI-powered tools."
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-8 max-w-md">Select the category of the asset you wish to list. All assets undergo a rigorous concierge review.</p>
                ...
                <div className="space-y-6 md:space-y-8 flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                      {categories.map(cat => (
                        ...
                        >
                          ...
                          <span className="text-[10px] md:text-xs text-gray-400">List your {cat.toLowerCase()}</span>
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50/50 p-4 md:p-5 rounded-2xl md:rounded-3xl border border-blue-100/50 flex items-start space-x-3 md:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] md:text-xs text-gray-500 leading-relaxed">Our team provides a custom valuation report within 24 hours of submission, ensuring your asset meets Coshare standards.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full max-w-md mx-auto space-y-4 md:space-y-6 mb-8 md:mb-12">
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4 text-left">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] md:text-xs text-gray-400">We handle the legal framework and registration for co-ownership.</p>
                    </div>
                  </div>
                </div>
