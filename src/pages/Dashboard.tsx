      ...
      <div className="min-h-screen bg-[#f8f9fa] py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {[1, 2].map((i) => (
              <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 flex flex-col sm:flex-row animate-pulse">
                <div className="sm:w-2/5 h-48 sm:h-auto bg-gray-200"></div>
          ...
          {activeTab === 'holdings' && (
            ...
            >
              ...
              {portfolioAssets.length === 0 ? (
                <div className="bg-white rounded-3xl p-12 text-center border-2 border-dashed border-gray-200 shadow-sm hover:border-[#256ab1]/30 transition-colors group">
                  <div className="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#256ab1]/5 transition-colors">
                    <Wallet className="w-10 h-10 text-gray-300 group-hover:text-[#256ab1] transition-colors" />
                  </div>
                  <h3 className="text-xl font-bold text-[#0b1b34] mb-2">{t('dashboard.holdings.empty')}</h3>
                  <p className="text-gray-500 mb-8 text-sm max-w-sm mx-auto">Discover premium assets and start building your co-ownership portfolio today.</p>
                  <button onClick={() => window.location.href = '/assets'} className="px-8 py-3 bg-[#0b1b34] text-white rounded-full font-bold uppercase tracking-widest text-xs hover:bg-[#0b1b34]/90 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-[#0b1b34]/20">
          ...
          {activeTab === 'marketplace' && (
            ...
            >
              ...
              {listings.length === 0 ? (
                <div className="bg-white rounded-3xl p-12 text-center border-2 border-dashed border-gray-200 shadow-sm hover:border-[#256ab1]/30 transition-colors group">
                  <div className="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#256ab1]/5 transition-colors">
                    <ShoppingBag className="w-10 h-10 text-gray-300 group-hover:text-[#256ab1] transition-colors" />
                  </div>
                  <h3 className="text-xl font-bold text-[#0b1b34] mb-2">{t('dashboard.marketplace.empty')}</h3>
                  <p className="text-gray-500 mb-8 text-sm max-w-sm mx-auto">{t('dashboard.marketplace.firstListing')}</p>
