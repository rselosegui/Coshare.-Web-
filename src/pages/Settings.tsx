      ...
      case 'notifications':
        return (
          <div className="space-y-6">
            <p className="text-sm text-gray-500 mb-6 font-medium">Choose how you want to receive updates about your shared assets and bookings.</p>
      ...
      case 'privacy':
        return (
          <div className="prose prose-sm max-h-[60vh] overflow-y-auto pr-4">
            ...
            <p className="text-gray-500 font-medium">We collect information that you provide directly to us, including when you create an account, make an asset purchase, or communicate with our concierge team.</p>
