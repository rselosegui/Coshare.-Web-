      ...
      <div className="min-h-screen bg-[#f8f9fa] py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 sm:mb-12 gap-4">
            ...
            <div className="h-12 w-full md:w-80 bg-gray-200 rounded-full animate-pulse"></div>
          </div>
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 flex justify-between items-end">
                    ...
                    <div className="text-right">
                      <div className="h-3 w-16 bg-gray-200 rounded mb-2 ml-auto"></div>
    ...
    <div className="min-h-screen bg-[#f8f9fa] py-16 md:py-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="absolute inset-0 z-0">
              <img 
                ...
                alt="Sailing boat with city skyline"
        ...
        {filteredAssets.length === 0 && activeCategory !== 'Yachts' && (
          <div className="bg-white rounded-3xl p-12 text-center border-2 border-dashed border-gray-200 shadow-sm hover:border-[#256ab1]/30 transition-colors group max-w-2xl mx-auto my-12">
            <div className="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#256ab1]/5 transition-colors">
              <Search className="w-10 h-10 text-gray-300 group-hover:text-[#256ab1] transition-colors" />
            </div>
            <h3 className="text-xl font-bold text-[#0b1b34] mb-2">{t('assets.empty')}</h3>
            <p className="text-gray-500 mb-8 text-sm max-w-sm mx-auto">{t('assets.empty.desc')}</p>
            <button 
              onClick={() => { setActiveCategory('All'); setActiveSubcategory('All'); }}
              className="px-8 py-3 bg-[#0b1b34] text-white rounded-full font-bold uppercase tracking-widest text-xs hover:bg-[#0b1b34]/90 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-[#0b1b34]/20"
            >
              Clear Filters
            </button>
          </div>
