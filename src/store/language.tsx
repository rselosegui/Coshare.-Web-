...
export const translations: Translations = {
  ...
  'home.hero.owner1.text': { EN: 'Own the yacht, share the time. AI handles the rest.', AR: 'امتلك اليخت وشارك الوقت. الذكاء الاصطناعي يتولى الباقي.' },
  'home.hero.dreamer1.text': { EN: 'Swap the city car for a 4x4 when adventure calls.', AR: 'استبدل سيارة المدينة بسيارة دفع رباعي حينما تناديك المغامرة.' },
  'home.hero.owner2.text': { EN: 'My GT3 earns Swap Credits perfectly managed while I travel.', AR: 'سيارتي GT3 تكسب رصيد تبادل وتُدار بشكل مثالي أثناء سفري.' },
  'home.hero.dreamer2.text': { EN: 'Booked an e-foil for the afternoon. Absolute game-changer.', AR: 'حجزت لوح تزلج مائي لفترة ما بعد الظهر. تجربة لا تُنسى.' },
  'home.hero.owner3.text': { EN: 'Split the cost of a Harley, keep the thrill of the ride.', AR: 'قسّم تكلفة هارلي، واحتفظ بإثارة الركوب.' },
  'home.hero.dreamer3.text': { EN: 'A convertible road trip with zero long-term commitment.', AR: 'رحلة بسيارة مكشوفة بصفر التزامات طويلة الأمد.' },
  'home.hero.owner4.text': { EN: 'Trade unused beach house weeks for boat days and road trips.', AR: 'بادل أسابيع المنزل الصيفي غير المستخدمة بأيام على القارب ورحلات برية.' },
  'home.hero.dreamer4.text': { EN: 'Wake up to a private speedboat, skip the club fees.', AR: 'استيقظ على قارب سريع خاص، وتخطى رسوم النادي.' },
