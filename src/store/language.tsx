...
export const translations: Translations = {
  ...
  'home.why.subtitle': { EN: 'Replace the friction of expensive ownership and chaotic sharing with a single, integrated ecosystem. We manage the entire lifecycle of assets, providing the infrastructure to co-own, manage, and swap seamlessly.', AR: 'استبدل عناء الملكية المكلفة والمشاركة الفوضوية بمنظومة واحدة متكاملة. نحن ندير الدورة الكاملة للأصول، ونوفر البنية التحتية للتملك المشترك والإدارة والتبادل بسلاسة.' },
  ...
  'home.why.2.desc': { EN: 'No more messy group chats or chasing payments. Our app automatically splits maintenance, insurance, and storage costs fairly among co-owners.', AR: 'لا مزيد من المحادثات الجماعية الفوضوية أو ملاحقة المدفوعات. يقوم تطبيقنا تلقائياً بتقسيم تكاليف الصيانة والتأمين والتخزين بشكل عادل بين الملاك.' },
  'home.why.2.badge': { EN: 'Fair Splits', AR: 'تقسيم عادل' },
  'home.why.3.title': { EN: 'Conflict-Free Scheduling', AR: 'جدولة بلا نزاعات' },
  'home.why.3.desc': { EN: 'Our AI manages the heavy lifting—from scheduling proactive maintenance to preserve asset longevity, to impartially mediating any co-owner disputes.', AR: 'يدير الذكاء الاصطناعي مهامك الصعبة - بدءاً من جدولة الصيانة الاستباقية للحفاظ على عمر الأصل، إلى التوسط النزيه في أي نزاعات بين الملاك.' },
  'home.why.3.badge': { EN: 'Peaceful Co-owning', AR: 'ملكية هادئة' },
  'home.why.4.title': { EN: 'Generate Earnings', AR: 'توليد الأرباح' },
  'home.why.4.desc': { EN: 'Let your asset work for you. Put your unused time into the network to automatically offset your carrying costs.', AR: 'دع أصلك يعمل لصالحك. ضع وقتك غير المستخدم في الشبكة لتعويض تكاليفك الجارية تلقائياً.' },
  'home.why.4.badge': { EN: 'Smart Savings', AR: 'دخل سلبي' },
  'home.why.5.title': { EN: 'Easy to Sell', AR: 'سهل البيع' },
  'home.why.5.desc': { EN: "Your share isn't stuck forever. When you're ready to move on, instantly list your fraction on our public marketplace to sell it to the community.", AR: 'حصتك ليست عالقة للأبد. عندما تكون مستعداً للانتقال، اعرض حصتك فوراً في سوقنا العام لبيعها للمجتمع.' },
  'home.why.5.badge': { EN: 'Easy Exits', AR: 'مخارج سهلة' },
  'home.why.6.title': { EN: 'Smart Ownership', AR: 'ملكية ذكية' },
  'home.why.6.desc': { EN: 'Stop paying full price for assets you only use 10% of the time. Buy shares from 1/2 to 1/12 and enjoy them proportionally while our AI handles the rest.', AR: 'لا مزيد من المحادثات الجماعية الفوضوية أو ملاحقة المدفوعات. يقوم تطبيقنا تلقائياً بتقسيم تكاليف الصيانة والتأمين والتخزين بشكل عادل بين الملاك.' },
  'home.why.6.badge': { EN: 'Smart Ownership', AR: 'ملكية ذكية' },
  'home.why.7.title': { EN: 'Safe, Legal & Insured', AR: 'آمن وقانوني ومؤمن' },
  'home.why.7.desc': { EN: "We strip away the red tape. Every asset is officially registered, insured, and structured safely so you can co-own with total peace of mind.", AR: 'نحن نزيل الروتين المتعلق بالإجراءات. يتم تسجيل كل أصل وتأمينه وهيكلته بأمان حتى تتمكن من المشاركة براحة بال تامة.' },
  'home.why.7.badge': { EN: '100% Legal', AR: 'قانوني 100%' },
  'home.why.8.title': { EN: 'Care Services', AR: 'خدمات الرعاية' },
  'home.why.8.desc': { EN: 'Hire on-demand services directly through the app—including professional cleaning, fueling, global delivery, and secured storage for all your assets.', AR: 'اطلب خدمات حسب الطلب مباشرة من خلال التطبيق - بما في ذلك التنظيف الاحترافي، والتزويد بالوقود، والتوصيل العالمي، والتخزين الآمن لجميع أصولك.' },
  'home.why.8.badge': { EN: 'Comfort Care', AR: 'رعاية مريحة' },
  'home.how.title': { EN: 'How it works', AR: 'كيف تعمل' },
  'home.how.subtitle': { EN: 'Share your assets, swap for the experiences you want, and co-own what you love, all managed by AI. Four simple steps to owning and enjoying assets.', AR: 'شارك أصولك، وبادل للحصول على التجارب التي تريدها، وشارك في ملكية ما تحب، كل ذلك يُدار بواسطة الذكاء الاصطناعي. أربع خطوات بسيطة لامتلاك والاستمتاع بالأصول.' },
  ...
  'home.useCases.subtitle': { EN: 'Built for pragmatists, explorers, and communities tired of the "all-or-nothing" approach to assets. If you value your time as much as your gear, you\'re in the right place.', AR: 'بُنيت لأصحاب العقول العملية والمستكشفين والمجتمعات التي سئمت من نهج "الكل أو لا شيء" تجاه الأصول. إذا كنت تُقدّر وقتك بقدر ما تُقدّر أدواتك، فأنت في المكان الصحيح.' },
  ...
  'home.cta.earlyAdopters': { EN: 'Early  Cosharers', AR: 'المشاركون التعاونيون الأوائل' },
  ...
  'how.share.step1.title': { EN: '01. List Your Asset', AR: '٠١ اعرض أصلك' },
  'how.share.step1.desc': { EN: 'Got a car, boat, or property sitting idle? Set your availability, define custom rules, and let AI smoothly create the perfect listing for you in minutes.', AR: 'هل لديك سيارة أو قارب أو عقار خامل؟ حدد توفرك، ضع قواعد مخصصة، ودع الذكاء الاصطناعي ينشئ إدراجاً مثالياً لك بسلاسة في دقائق.' },
  'how.share.step1.point1': { EN: 'Complete control over your schedule', AR: 'تحكم كامل في جدولك' },
  'how.share.step1.point2': { EN: 'AI-generated optimal pricing', AR: 'تسعير مثالي بالذكاء الاصطناعي' },
  'how.share.step1.point3': { EN: 'You decide who gets access', AR: 'أنت تقرر من يحق له الوصول' },
  'how.share.step2.title': { EN: '02. Rest Easy', AR: '٠٢ اطمئن' },
  'how.share.step2.desc': { EN: 'Never worry about who is using your asset. Every single user undergoes strict identity checks and continuous behavioral scoring before they can book.', AR: 'لا تقلق أبداً بشأن من يستخدم أصلك. يخضع كل مستخدم لفحوصات هوية صارمة، وتسجيل سلوكي مستمر قبل أن يتمكن من الحجز.' },
  'how.share.step2.point1': { EN: 'Strict community vetting', AR: 'تدقيق صارم للمجتمع' },
  'how.share.step2.point2': { EN: 'Comprehensive insurance policy', AR: 'بوليصة تأمين شاملة' },
  'how.share.step2.point3': { EN: 'Continuous behavioral scoring', AR: 'تسجيل سلوكي مستمر' },
  'how.share.step3.title': { EN: '03. Seamless Handovers', AR: '٠٣ تسليم سلس' },
  'how.share.step3.desc': { EN: 'Sit back while our platform manages the entire process. From digital key handovers to automated condition reports before and after every trip.', AR: 'استرخِ بينما تدير منصتنا العملية بأكملها. بدءاً من تسليم المفاتيح الرقمية وحتى تقارير الحالة التلقائية قبل وبعد كل رحلة.' },
  'how.share.step3.point1': { EN: 'Digital locks and remote access', AR: 'أقفال رقمية ووصول عن بعد' },
  'how.share.step3.point2': { EN: 'AI condition verification', AR: 'تحقق من الحالة بالذكاء الاصطناعي' },
  'how.share.step3.point3': { EN: 'Optional valet and cleaning', AR: 'خدمة صف السيارات والتنظيف الاختيارية' },
  'how.share.step4.title': { EN: '04. Earn & Swap', AR: '٠٤ اكسب وبادل' },
  'how.share.step4.desc': { EN: 'Turn idle time into real value. Offset your ownership costs through direct earnings, or collect Swap Credits to spend on other assets in the network.', AR: 'حوّل وقت الخمول إلى قيمة حقيقية. عوض تكاليف ملكيتك من خلال الأرباح المباشرة، أو اجمع أرصدة التبادل لإنفاقها على أصول أخرى في الشبكة.' },
  'how.share.step4.point1': { EN: 'Offset your running costs', AR: 'تعويض تكاليف التشغيل' },
  'how.share.step4.point2': { EN: 'Earn Swap Credits for travel', AR: 'كسب أرصدة مبادلة للسفر' },
  'how.share.step4.point3': { EN: 'Dedicated wallet for earnings', AR: 'محفظة مخصصة للأرباح' },
  'how.own.step1.title': { EN: '01. Buy a Share', AR: '٠١. اشترِ حصة' },
  'how.own.step1.desc': { EN: 'Why pay 100% for something you only use 10% of the time? Browse verified real estate, boats, and cars, and buy exactly the slice you need (like 1/8th).', AR: 'لماذا تدفع ١٠٠٪ مقابل شيء تستخدمه ١٠٪ فقط من الوقت؟ تصفح العقارات والقوارب والسيارات الموثقة، واشترِ الحصة التي تحتاجها بالضبط (مثل ١/٨).' },
  'how.own.step1.point1': { EN: 'Pay a fraction of the cost', AR: 'ادفع جزءاً من التكلفة' },
  'how.own.step1.point2': { EN: 'Curated, high-quality assets', AR: 'أصول منتقاة وعالية الجودة' },
  'how.own.step1.point3': { EN: 'Transparent pricing, no surprises', AR: 'تسعير شفاف، بدون مفاجآت' },
  'how.own.step2.title': { EN: '02. Team Up Safely', AR: '٠٢. تعاون بأمان' },
  'how.own.step2.desc': { EN: 'Connect with verified co-owners in a secure environment. We handle the legal paperwork, secure payments, and insurance automatically so you don\'t have to.', AR: 'تواصل مع ملاك مشاركين موثوقين في بيئة آمنة. نحن نتعامل مع الأعمال الورقية، والمدفوعات الآمنة، والتأمين تلقائياً نيابة عنك.' },
  'how.own.step2.point1': { EN: 'Strict community vetting', AR: 'تدقيق صارم للمجتمع' },
  'how.own.step2.point2': { EN: 'Paperwork is handled for you', AR: 'يتم التعامل مع الأعمال الورقية لك' },
  'how.own.step2.point3': { EN: 'Complete liability protection', AR: 'حماية كاملة من المسؤولية' },
  'how.own.step3.title': { EN: '03. Smart Management', AR: '٠٣. إدارة ذكية' },
  'how.own.step3.desc': { EN: 'Enjoy the asset without the stress. AI takes the friction out of ownership by fairly sharing the calendar, tracking maintenance, and automatically splitting bills.', AR: 'استمتع بالأصل دون ضغوط. يزيل الذكاء الاصطناعي الاحتكاك من الملكية من خلال المشاركة العادلة للتقويم، وتتبع الصيانة، وتقسيم الفواتير تلقائياً.' },
  'how.own.step3.point1': { EN: 'Fair scheduling for peak seasons', AR: 'جدولة عادلة لمواسم الذروة' },
  'how.own.step3.point2': { EN: 'Automated expense splitting', AR: 'تقسيم تلقائي للمصروفات' },
  'how.own.step3.point3': { EN: 'Proactive maintenance alerts', AR: 'تنبيهات صيانة استباقية' },
  'how.own.step4.title': { EN: '04. Swap or Sell', AR: '٠٤. بادل أو بِع' },
  'how.own.step4.desc': { EN: 'You\'re never locked in. Release your unused days to the network for global Swap Credits, or easily list your share on our marketplace if you\'re ready to move on.', AR: 'أنت لست مقيداً أبداً. حرر أيامك غير المستخدمة للشبكة للحصول على أرصدة مبادلة عالمية، أو يمكنك بسهولة إدراج حصتك في سوقنا للتخارج.' },
  'how.own.step4.point1': { EN: 'Earn credits for unused days', AR: 'اكسب أرصدة للأيام غير المستخدمة' },
  'how.own.step4.point2': { EN: 'Swap for global experiences', AR: 'بادل للحصول على تجارب عالمية' },
  'how.own.step4.point3': { EN: 'Easy to sell on the marketplace', AR: 'سهل البيع في السوق' },
  ...
  'how.concierge.title': { EN: 'All-Inclusive Asset Care', AR: 'رعاية شاملة للأصول' },
  ...
  'how.concierge.insurance': { EN: 'Insurance & Compliance', AR: 'التأمين والامتثال' },
  'how.concierge.insuranceDesc': { EN: 'Comprehensive coverage and RTA/DCMA compliance handled annually.', AR: 'تغطية شاملة وامتثال لهيئة الطرق والمواصلات / سلطة مدينة دبي الملاحية سنوياً.' },
  ...
  'how.concierge.handover': { EN: 'Digital Handover', AR: 'التسليم الرقمي' },
  'how.concierge.handoverDesc': { EN: 'Protect your asset with required photo reports before and after every use.', AR: 'احمِ أصلك بتقارير صور مطلوبة قبل وبعد كل استخدام.' },
  'how.concierge.valet': { EN: 'Valet & Detailing', AR: 'خدمة تنظيف السيارات وتلميعها' },
  'how.concierge.valetDesc': { EN: 'Professional cleaning and interior detailing before your shift begins.', AR: 'تنظيف وتلميع احترافي للداخل قبل بدء نوبتك.' },
  'how.concierge.refueling': { EN: 'Refueling & Charging', AR: 'تعبئة الوقود والشحن' },
  'how.concierge.refuelingDesc': { EN: 'Return the asset without worrying—we handle the gas or electric charge.', AR: 'أعد الأصل دون قلق - نحن نتولى تعبئة الوقود أو الشحن الكهربائي.' },
  'how.concierge.relocation': { EN: 'Relocation & Delivery', AR: 'النقل والتوصيل' },
  'how.concierge.relocationDesc': { EN: 'Need it at the marina or your driveway? We deliver it exactly where you want it.', AR: 'هل تحتاجه في المرسى أو ممر سيارتك؟ نقوم بتوصيله بالضبط إلى المكان الذي تريده.' },
  'how.concierge.provisioning': { EN: 'Provisioning', AR: 'التموين' },
  'how.concierge.provisioningDesc': { EN: 'Groceries, ice, and gear fully stocked and ready before you step aboard.', AR: 'البقالة والثلج والمعدات مخزنة بالكامل وجاهزة قبل الصعود على متن القارب.' },
  ...
  'listAsset.hero.subtitle': { EN: 'Stop letting your asset sit idle. Choose to sell fractions to free up cash, list it entirely for swapping to earn credits, or combine both to maximize your asset\'s utility. Let us take the friction out of ownership.', AR: 'لا تدع أصلك يبقى خاملاً. اختر بيع الحصص لتحرير النقد، أو إدراجه بالكامل للمبادلة لكسب الأرصدة، أو اجمع بين كليهما لزيادة فائدة أصلك. دعنا نزيل الاحتكاك من الملكية.' },
  ...
  'listAsset.globalKey.desc': { EN: 'Listing your asset provides ultimate flexibility. Whether you cash out equity through fractional sales or simply earn Swap Credits by sharing unused days, you instantly unlock access to a global network of vehicles and properties.', AR: 'يوفر إدراج أصلك مرونة مطلقة. سواء قمت بصرف حقوق الملكية من خلال المبيعات الجزئية أو كسبت أرصدة التبادل ببساطة عن طريق مشاركة الأيام غير المستخدمة، ستفتح لك إمكانية الوصول الفوري إلى شبكة عالمية من المركبات والعقارات.' },
  'listAsset.step1.title': { EN: '01. Submit & Evaluate', AR: '٠١ التقديم والتقييم' },
  'listAsset.step1.desc': { EN: 'Upload high-quality photos, specifications, and your desired listing strategy. Our team will review the submission to ensure it meets Coshare\'s global marketplace standards.', AR: 'قم بتحميل صور عالية الجودة والمواصفات واستراتيجية العرض التي تريدها. سيقوم فريقنا بمراجعة التقديم للتأكد من أنه يلبي معايير السوق العالمية لـ Coshare.' },
  'listAsset.step2.title': { EN: '02. Validation & Strategy', AR: '٠٢ التحقق والاستراتيجية' },
  'listAsset.step2.desc': { EN: 'We conduct an independent physical inspection and verify your ownership. Decide if you want to strictly share for Swap Credits, sell equity fractions to unlock cash, or a hybrid of both.', AR: 'نجري فحصاً مادياً مستقلاً ونتحقق من ملكيتك. حدد ما إذا كنت تريد المشاركة بصرامة مقابل أرصدة تبادل، أو بيع حصص أسهم لتحرير النقد، أو مزيج من الاثنين معاً.' },
  'listAsset.step3.title': { EN: '03. Legal Setup & Protection', AR: '٠٣ الإعداد القانوني والحماية' },
  'listAsset.step3.desc': { EN: 'We finalize the legal framework based on your strategy. If selling fractions, we establish the Shareholder Agreement (SHA). For all assets, we define user rights and activate insurance protocols.', AR: 'نقوم بوضع اللمسات الأخيرة على الإطار القانوني بناءً على استراتيجيتك. في حالة بيع حصص، نقوم بإنشاء اتفاقية المساهمين (SHA). لجميع الأصول، نحدد حقوق المستخدمين ونفعّل بروتوكولات التأمين.' },
  'listAsset.step4.title': { EN: '04. Go Live: Share, Swap, or Sell', AR: '٠٤ الإطلاق: شارك، بادل، أو بِع' },
  'listAsset.step4.desc': { EN: 'Your asset goes live on your exact terms. Receive upfront funds if selling equity, automatically earn Swap Credits when others use your asset, and unlock access to the entire global network.', AR: 'يتم إطلاق أصلك بشروطك الدقيقة. احصل على أموال مقدماً في حالة بيع حصص، واكسب أرصدة تبادل تلقائياً عندما يستخدم الآخرون أصلك، وافتح إمكانية الوصول إلى الشبكة العالمية بأكملها.' },
  ...
  'listAsset.why.3.title': { EN: 'Vetted Members', AR: 'أعضاء موثقون' },
