...
export const translations: Translations = {
  ...
  'home.hero.owner1.text': { EN: 'Why own one, when you can own four?', AR: 'لماذا تمتلك واحدة، بينما يمكنك امتلاك أربع؟' },
  ...
  'home.hero.resolution.row1': { EN: 'One platform. Three ways.', AR: 'منصة واحدة. ثلاث طرق.' },
  'home.hero.resolution.row2': { EN: 'Co-own, share, and swap', AR: 'امتلك مشتركاً، وشارك، وبادل' },
