...
export const translations: Translations = {
  ...
  'home.hero.subtitle': { EN: 'The AI-powered platform to collectively co-own and share cars, yachts, and real estate for a fractional of a cost and split cost.', AR: 'المنصة المدعومة بالذكاء الاصطناعي لامتلاك ومشاركة السيارات واليخوت والعقارات بشكل جماعي بجزء من التكلفة وتقسيم النفقات.' },
  'home.hero.start': { EN: 'Start Cosharing', AR: 'ابدأ المشاركة' },
  'home.why.title': { EN: 'Why coshare.', AR: 'لماذا coshare.' },
  'home.why.subtitle': { EN: 'A smarter way to collectively co-own, use, and manage assets all around the world. Make it public or private within your friends or circle.', AR: 'طريقة أذكى لامتلاك واستخدام وإدارة الأصول بشكل جماعي في جميع أنحاء العالم. اجعلها عامة أو خاصة ضمن أصدقائك أو دائرتك.' },
  ...
  'home.why.3.desc': { EN: 'Clear guidelines and AI-assisted mediation to handle any co-owner disputes smoothly.', AR: 'إرشادات واضحة ووساطة بمساعدة الذكاء الاصطناعي للتعامل مع أي نزاعات بين الملاك المشتركين بسلاسة.' },
  ...
  'home.faq.1.a': { EN: "Cosharing is a method in which several unrelated parties can share in, and mitigate the risk of, ownership of a high-value tangible asset. In Coshare's case, this includes supercars and yachts.", AR: 'المشاركة هي طريقة يمكن من خلالها لعدة أطراف غير مرتبطة المشاركة في ملكية أصل ملموس عالي القيمة وتخفيف مخاطرها. في حالة Coshare، يشمل ذلك السيارات الخارقة واليخوت.' },
  ...
  'home.faq.4.a': { EN: 'Yes. Coshare provides a secondary marketplace where you can list your shares for sale to other verified users within our community, providing liquidity without waiting for the asset to be sold entirely.', AR: 'نعم. توفر Coshare سوقاً ثانوياً حيث يمكنك عرض حصصك للبيع لمستخدمين آخرين تم التحقق منهم داخل مجتمعنا، مما يوفر السيولة دون انتظار بيع الأصل بالكامل.' },
  ...
  'home.faq.10.a': { EN: 'We have a structured conflict resolution protocol built into every co-ownership agreement. Minor scheduling issues are handled by our AI system, while more significant disputes (like damage claims) are mediated by our dedicated support team using clear, pre-agreed guidelines.', AR: 'لدينا بروتوكول منظم لحل النزاعات مدمج في كل اتفاقية ملكية مشتركة. يتم التعامل مع مشكلات الجدولة البسيطة بواسطة نظام الذكاء الاصطناعي الخاص بنا، بينما يتم التوسط في النزاعات الأكثر أهمية (مثل مطالبات الأضرار) من قبل فريق الدعم المخصص لدينا باستخدام إرشادات واضحة متفق عليها مسبقاً.' },
  'home.cta.title1': { EN: 'Start Cosharing', AR: 'ابدأ المشاركة' },
  'home.cta.title2': { EN: 'Today.', AR: 'اليوم.' },
  'home.cta.desc': { EN: 'Join a growing community of co-owners all around the world sharing Porsches, Mercedes-Benz, Land Rovers, and yachts. Download the Coshare mobile app to browse available assets, purchase shares, and book your time to use and enjoy instantly.', AR: 'انضم إلى مجتمع متنامٍ من الملاك المشاركين في جميع أنحاء العالم الذين يتشاركون سيارات بورش ومرسيدس بنز ولاند روفر واليخوت. قم بتنزيل تطبيق Coshare للهواتف المحمولة لتصفح الأصول المتاحة وشراء الحصص وحجز وقتك للاستخدام والاستمتاع على الفور.' },
  ...
  'how.step4.desc': { EN: 'Just show up and enjoy. Storage, cleaning, fueling, and delivering are services that can be hired within the platform.', AR: 'فقط احضر واستمتع. التخزين والتنظيف والتزويد بالوقود والتوصيل هي خدمات يمكن استئجارها داخل المنصة.' },
  ...
  'how.concierge.storage': { EN: 'Storage, Cleaning, Fueling, Delivering', AR: 'التخزين، التنظيف، التزويد بالوقود، التوصيل' },
