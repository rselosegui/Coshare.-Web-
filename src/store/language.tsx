...
export const translations: Translations = {
  ...
  'home.hero.subtitle': { EN: 'The AI-powered platform to collectively co-own and share cars, boats, and real estate for a fraction of the price, with all ongoing costs seamlessly split.', AR: '.المنصة المدعومة بالذكاء الاصطناعي لامتلاك السيارات واليخوت والعقارات ومشاركتها بشكل جماعي بجزء من السعر، مع تقسيم جميع التكاليف الجارية بسلاسة تامة' },
  ...
  'home.why.7.title': { EN: 'Compliance', AR: 'الامتثال' },
  'home.why.7.desc': { EN: 'Fully compliant with local regulations. Every asset is officially registered and structured under approved legal frameworks.', AR: '.متوافق تماماً مع اللوائح المحلية. يتم تسجيل كل أصل رسمياً وهيكلتها بموجب أطر قانونية معتمدة' },
