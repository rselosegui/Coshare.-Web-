...
export const VaultAssetDetails = ({ asset, onClose }: VaultAssetDetailsProps) => {
  ...
  const vaultInfo = {
    ...
    inspections: [
      { date: '2023-12-01', result: 'Passed', inspector: 'Global Inspector', notes: 'Perfect condition' },
            ...
            {activeTab === 'voting' && (
              ...
              >
                {[
                  { 
                    id: 1, 
                    title: 'Sell Asset at 15% Profit', 
                    desc: 'We received a private offer to buy the asset at a 15% profit over the current market value. Should we proceed?', 
                    status: 'Active',
                    yes: 45,
                    no: 10,
                    deadline: '2024-05-01'
